...
if guarda_figuras:
    for i in indices:
        ...
        fig.savefig("figuras/18-RKF452D-t-%1.3f.png" %t[i])
...
if make_video:
    ...
    animation.write_videofile('figuras/RKF452D.mp4', fps=video_fps, verbose=False, logger=None)
